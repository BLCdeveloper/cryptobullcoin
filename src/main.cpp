...
unsigned int nStakeMinAge = 8 * nOneHour; // 1 days as zero time weight
...
{
    int64_t nRewardCoinYear = 156 * CENT;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "bull genesis";
        CTransaction txNew;
        txNew.nTime = 1490548576;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1490548576;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1043228; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0xc1d3d4be1a5c624b24679fc67e8595bd6c345d524ed79cc6dac809c664e1afd6"));
...
unsigned char pchMessageStart[4] = { 0xb4, 0xfe, 0x92, 0xf5 };
